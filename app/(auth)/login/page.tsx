            ...
            <main className="flex flex-col gap-[32px] row-start-2 items-center max-sm:w-full">
                ...
                <form action=""
                    ...
                    <button type="button" onClick={login}
                            className="flex items-center rounded-full ps-4 pe-1 bg-gradient-to-br from-blue-500 via-green-500 to-indigo-500 dark:from-blue-600 dark:via-green-600 dark:to-indigo-600 text-white hover:cursor-pointer hover:shadow-2xl font-semibold">
                        <span className="py-1">
                            Login
                        </span>
