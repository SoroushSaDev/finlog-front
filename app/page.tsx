    ...
    return (
        <div
            ...
            <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
                <h1 className="text-9xl max-sm:text-8xl max-sm:font-semibold bg-gradient-to-r from-blue-600 via-green-500 to-indigo-600 inline-block text-transparent bg-clip-text">
                    FinLog
                </h1>
